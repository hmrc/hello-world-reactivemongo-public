...
@Singleton
class ChaosScheduler @Inject()(service: HelloWorldService, repo: HelloWorldRepository, chaosRepo: ChaosRepository, actorSystem: ActorSystem, configuration: Configuration) {

  if(configuration.getBoolean("chaos").getOrElse(false) ) {
